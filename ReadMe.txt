...
Directories :
 - BIN		: the directory where the programm will be compiled to
...
Files :
 ...
 - SRC/main.c			: source file for main programm that call functions to manage menus and the graph structure
